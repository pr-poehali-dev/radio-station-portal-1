...
export default function Favorites() {
  ...
  return (
    <div className="container py-6 animate-fade-in">
      <h1 className="font-oswald text-3xl font-bold gradient-text mb-6 flex items-center gap-2">
        <Icon name="Heart" size={28} className="text-pink-400" />
        Избранное
      </h1>
      ...
      {loading ? (
        ...
        <>
          <p className="text-muted-foreground text-sm mb-4">{favorites.length} станций в избранном</p>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
